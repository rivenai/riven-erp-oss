...
* addon: the Riven ERP addon in which the file is;
...
try:
    ...
    # executed via riven-erp-bin), happily release/parse_version are
    # standalone so we can hack our way there without importing Riven ERP
